<template>
  <div class="login-container">
    <el-form ref="loginFormRef" :model="loginForm" :rules="loginRules" class="login-form" size="small" auto-complete="on" label-position="left">

      <div class="title-container">
        <h3 class="title">硬X射线实验室预约平台</h3>
      </div>
      ...
      this.$refs.loginFormRef.validate(valid => {
        if (valid) {
          ...
          this.$store.dispatch('user/login', this.loginForm).then((res) => {
            ...
            let past = res.data.data.updateTime;
            let diff = (current-past) / (24 * 3600 * 1000);
            this.loading = false
